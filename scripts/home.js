...
/*
            "image":"https://amazingeventsapi.herokuapp.com/api/img/Feriadecomidas7.jpg",
            "name":"Collectivities Party", (Card)
            "date":"2021-12-12", (Card)
            "description":"Enjoy your favourite dishes, from different countries, in a unique event for the whole family.",(Card)
            "category":"Food Fair", (Card)
            "place":"Room A",
            "capacity":45000,
            "assistance":42756,
            "price":5 (Card)
...
for (let i = 0; i < eventos.events.length; i++){
    ...
    containerCart.innerHTML = `
                <div class="card">
                    <img src=${eventos.events[i].image} class="card-img-top" alt="">
                    <div class="card-body">
                        <h5 class="card-title ">${eventos.events[i].name}</h5>
                        <p class="card-text text-black mb-0">${eventos.events[i].date}</p>
                        <p class="card-text text-success mb-0">${eventos.events[i].category}</p>
                        <p class="card-text ">${eventos.events[i].description}</p>
                        <div class="row">
                            <div class="col">
                                <span class="fs-5">Price $${eventos.events[i].price}</span>
                            </div>
                            <div class="col">
            ...
            `
    eventosElement.appendChild(containerCart)
}
